 ...
 * @author ubriela
 */
public class WithinDistanceQueryAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
            HttpServletRequest request, HttpServletResponse response) {
        {
            ...
            try {
                ...
                float dis = Float.valueOf(request.getParameter("dis"));
                ...
                Vector buildings = instance.queryWithinDistance(center, tableName, dis, unit);
                ...
                while (it.hasNext()) {
                    ...
                    Point2D location = null;
                    {
                        ...
                        try {
                            ...
                            Logger.getLogger(WithinDistanceQueryAction.class.getName()).log(Level.SEVERE, null, ex);
